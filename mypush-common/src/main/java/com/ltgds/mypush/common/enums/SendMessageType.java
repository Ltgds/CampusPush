 ...
 * @author Li Guoteng
 * @data 2023/8/6
 * @description 微信应用消息/钉钉/服务号 均有多种的消息类型下发
 */
@Getter
@ToString
@AllArgsConstructor
public enum SendMessageType {
     ...
     * @return
     */
    public static String getDingDingRobotTypeCode(String code) {
        SendMessageType[] values = SendMessageType.values();

        for (SendMessageType value : values) {
